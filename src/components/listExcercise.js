		...
		return (
			<TableRow
				...
				<TableCell align='center'>
					{excercise.exerciseType.exerciseType}
				</TableCell>
				<TableCell align='center'>
					{excercise.difficulty.exerciseDifficulty}
				</TableCell>
				<TableCell align='center'>
				...
				<TableCell align='center'>
					<SearchIcon
						onClick={() =>
							excerciseListUS ? handleClickView(excercise._id) : null
						}
					/>
				</TableCell>
				<TableCell align='center'>
					<EditIcon
						onClick={() =>
							excerciseListUS ? handleClickEdit(excercise._id) : null
						}
					/>
				</TableCell>
				<TableCell align='center'>
					<DeleteOutlinedIcon
						onClick={() =>
							excerciseListUS ? handleClickDelte(excercise._id) : null
						}
					/>
				</TableCell>
			</TableRow>
		...
		return (
			<div>
				...
				<div style={{ display: 'flex', justifyContent: 'flex-end' }}>
					<Button
						variant='contained'
						onClick={handleClickNewExcerciseButton}>
						Nuevo Ejercicio
					</Button>
				</div>
